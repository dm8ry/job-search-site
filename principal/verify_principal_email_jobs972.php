<?php session_start(); 
	...
	if  (isset($_GET['uobjid']))
	{
		...
		$sql0 = "SELECT * FROM principals where trim(verification_salt) = trim('".$_GET['uobjid']."') and is_verified=0 ";
		...
		{    		
			...
			$subject = "Principal Email Has Verified Jobs972.com";		
			...
			$message = '<html><body>Hello, Jobs972.com!' . '<br/><br/> ' ."\n" .
						 'Principal Email Was Successfully Verified on the Jobs972.com!' . '<br/><br/> ' ."\n" .
						 'Verify Date: <b>' . $cur_dt . '</b><br/> ' ."\n" .
						 'Principal Email: <b>' . $arr_user_details[0]['princ_email'] . '</b><br/>' ."\n" .
						 'Principal Firstname: <b>' . $arr_user_details[0]['princ_firstname'] . '</b><br/>' ."\n" .
						 'Principal Lastname: <b>' . $arr_user_details[0]['princ_lastname'] . '</b><br/>' ."\n" .
			...
			$message2 = '<html><body> ' ."\n" .
						...
						'Verify Date: <b>' . $cur_dt . '</b><br/> ' ."\n" .
						'Your Email: <b>' . $arr_user_details[0]['princ_email'] . '</b><br/>' ."\n" .
						'Your Firstname: <b>' . $arr_user_details[0]['princ_firstname'] . '</b><br/>' ."\n" .
						'Your Lastname: <b>' . $arr_user_details[0]['princ_lastname'] . '</b><br/>' ."\n" .
			...
			{  				
				...
				VALUES ('$db_cur_dt', 17, 0, '$ip_addr', '$verified_email', '$message', '$message2', '')";
				...
				$sql2= 'update principals set is_verified = 1 where trim(verification_salt) =  trim(\''.$_GET['uobjid'].'\')';
				...
				{	
					...
					header('Location: https://jobs972.com/principal/thankyouemailverified.php');					
				}
		 	} 		

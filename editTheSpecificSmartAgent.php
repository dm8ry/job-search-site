<?php session_start();
	...
	if (isset($_POST['smagent_id']))
	{
		...
		$subject = "The Smart Agent was updated from the Jobs972.com";	

		$smagent_id = $_POST['smagent_id'];		
		
		$p1_recent_days = $_POST['sma_edit_days_select'];
		$p2_region_city = $_POST['sma_edit_region_n_city_select'];		
		$p3_category = $_POST['sma_edit_categories_select'];
		$p4_sub_category = $_POST['sma_edit_sub_categories_select'];
		$p5_contains_txt = $_POST['sma_edit_contains_txt'];
		...
		$message = '<html><body>Hello, Jobs972.com!' . '<br/><br/> ' ."\n" .
					 'Smart Agent was updated on the Jobs972.com!' . '<br/><br/> ' ."\n" .
		...
		$message2 = '<html><body> ' ."\n" .
					 'Smart Agent Was Updated on the Jobs972.com!' . '<br/>' ."\n" .
					 'Update Date: <b>' . $cur_dt . '</b><br/> ' ."\n" .					
					 'Find Positions for: <b>' . $p1_recent_days . '</b> recent days.<br/>' ."\n" .
					 $msg_region_city.
					 $msg_category.
		...
		{  				
			...
			VALUES ('$db_cur_dt', 15, 0, '$ip_addr', '$logged_in_email', '$message', '$message2', '')";
			...
			$sql2 = "update smart_agent 
						set modify_dt='$db_cur_dt' ,
							p1_recent_days = $p1_recent_days,
							p2_region_city = '$p2_region_city',
							p3_category = $p3_category,
							p4_sub_category = $p4_sub_category,
							p5_contains_txt = trim('$p5_contains_txt')
						where id = ".$smagent_id;

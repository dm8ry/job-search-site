<?php session_start(); 
	...
	if ( isset($_POST['the_curr_page']) && isset($_POST['recs_per_page']) && isset($_SESSION['logged_in_email']) && isset($_SESSION['logged_in_userid']) )
	{
		...
		if ($tot_n_of_recs > 0)
		{
			...
			$part_2 = '<div class="container">    
						<div class="row">  
						   <div class="col-md-12">
						   <br/> 
						   <p>The list of recent positions recommended to you:</p>'  ."\n";
									...
									' <div class="panel panel-default"> '."\n".  		
										...
										<div class="panel-body">
											 <table style="border-spacing: 10px; border-collapse: separate;">
												...
												<div class="pull-left">
													<a class="btn btn-default pull-right" onClick="areYouSurePositionNotInterested('.$arr_the_recs_detailed[$idx]['up_id'].');" style="border-radius: 24px;">I\'m not interested</a>
												</div>										 
												<div class="pull-right">
													<a class="btn btn-primary pull-right" onClick="positionToApply('.$arr_the_recs_detailed[$idx]['up_id'].' , \''.$arr_the_recs_detailed[$idx]['pos_title'].' @ '.$arr_the_recs_detailed[$idx]['company_name'].'\');" style="border-radius: 24px;">Apply</a>													
												</div>
												<div class="clearfix"></div>
										</div>
									</div>
		...
		{			
			echo  json_encode(array("val_1" =>  "<br/>No Recommended Positions Yet...", "val_2" => 0));
		}

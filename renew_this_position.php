<?php session_start();
		...
		)
	{
		...
		$subject = "The Position $the_position_title Was Renewed on the Jobs972.com";		
		...
		$message = '<html><body>Hello, Jobs972.com!' . '<br/><br/> ' ."\n" .
					 'The Position Was Renewed On the Jobs972.com!' . '<br/><br/> ' ."\n" .
					 'Renewal Date: <b>' . $cur_dt . '</b><br/> ' ."\n" .
		...
		$message2 = '<html><body> ' ."\n" .
					 'You Have Renewed The Position on the Jobs972.com!' . '<br/>' ."\n" .
					 'Renewal Date: <b>' . $cur_dt . '</b><br/> ' ."\n" .
		...
		{  				
			...
			VALUES ('$db_cur_dt', 26, $princ_id, '$ip_addr', '$princ_email', '$message', '$message2', '')";

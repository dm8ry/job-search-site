...
function FindJobsFilter()
{
	...
	location.href = "https://jobs972.com/positions.php?p=<? echo $p; ?>&c="+strCity+"&s="+strSearch;
}
			...
			{			
				...
				<div class="panel panel-default">
					...
					<div class="panel-heading" style="background:<? echo $positions_header_background_color; ?>;">
						...
						<div class="pull-left">
						  <a href='positions.php?i=<? echo $arr_positions[$idx]['id']; ?>'><?php echo $to_put_b.$arr_positions[$idx]['pos_title']." @ ".$arr_positions[$idx]['company_name']." [#".$arr_positions[$idx]['id']."]".$to_put_b2; ?></a>
						  <? 
					...
					<div class="panel-body" style="background:<? echo $positions_background_color; ?>;">
						 <table style="border-spacing: 10px; border-collapse: separate;">
							...
							<tr>
								...
								<td>
									<a href='positions.php?c=<?php echo $arr_positions[$idx]['locatio_id']; ?>'><?php echo $arr_positions[$idx]['locatio']; ?></a>
								</td>
							</tr>	
							<?
							}
							...
							<tr>
								...
								<td>
									<? if ($arr_positions[$idx]['cat_1'] != '') { ?><a href="positions.php?ca=<? echo $arr_positions[$idx]['cat_1_id']; ?>"><? echo $arr_positions[$idx]['cat_1']; ?></a> / <a href="positions.php?sc=<? echo $arr_positions[$idx]['scat_1_id']; ?>"><? echo $arr_positions[$idx]['scat_1']; ?></a><br/><? } ?>
									<? if ($arr_positions[$idx]['cat_2'] != '') { ?><a href="positions.php?ca=<? echo $arr_positions[$idx]['cat_2_id']; ?>"><? echo $arr_positions[$idx]['cat_2']; ?></a> / <a href="positions.php?sc=<? echo $arr_positions[$idx]['scat_2_id']; ?>"><? echo $arr_positions[$idx]['scat_2']; ?></a><br/><? } ?>
									<? if ($arr_positions[$idx]['cat_3'] != '') { ?><a href="positions.php?ca=<? echo $arr_positions[$idx]['cat_3_id']; ?>"><? echo $arr_positions[$idx]['cat_3']; ?></a> / <a href="positions.php?sc=<? echo $arr_positions[$idx]['scat_3_id']; ?>"><? echo $arr_positions[$idx]['scat_3']; ?></a><br/><? } ?>
									<? if ($arr_positions[$idx]['cat_4'] != '') { ?><a href="positions.php?ca=<? echo $arr_positions[$idx]['cat_4_id']; ?>"><? echo $arr_positions[$idx]['cat_4']; ?></a> / <a href="positions.php?sc=<? echo $arr_positions[$idx]['scat_4_id']; ?>"><? echo $arr_positions[$idx]['scat_4']; ?></a><br/><? } ?>
									<? if ($arr_positions[$idx]['cat_5'] != '') { ?><a href="positions.php?ca=<? echo $arr_positions[$idx]['cat_5_id']; ?>"><? echo $arr_positions[$idx]['cat_5']; ?></a> / <a href="positions.php?sc=<? echo $arr_positions[$idx]['scat_5_id']; ?>"><? echo $arr_positions[$idx]['scat_5']; ?></a><br/><? } ?>
								</td>
							</tr>
							<?
							...
							<div class="social">								
								...
								<p class="social">															
									<a href="https://www.facebook.com/sharer/sharer.php?u=https://www.jobs972.com/positions.php?i=<? echo $arr_positions[$idx]['id']; ?>" target='_blank' class="facebook external" data-animate-hover="shake"><i class="fa fa-facebook"></i></a>
									
									<a href="http://twitter.com/share?text=<?php echo "Jobs972.com: ".$arr_positions[$idx]['pos_title']." @ ".$arr_positions[$idx]['company_name']; ?>&url=https://jobs972.com/positions.php?i=<? echo $arr_positions[$idx]['id']; ?>&hashtags=jobs972,Job,Israel,לוח,משרות,עבודה,חיפוש, דרושים" target='_blank' class="twitter external" data-animate-hover="shake"><i class="fa fa-twitter"></i></a>
									
									<a href="http://www.linkedin.com/shareArticle?mini=true&url=https://jobs972.com/positions.php?i=<? echo $arr_positions[$idx]['id']; ?>&title=<?php echo $arr_positions[$idx]['pos_title']." @ ".$arr_positions[$idx]['company_name']; ?>&summary=<?php echo substr($arr_positions[$idx]['pos_desc'], 0, 600)."..."; ?>&source=https://jobs972.com" target='_blank' class="linkedin external" data-animate-hover="shake"><i class="fa fa-linkedin"></i></a>
				...
				?>
					...
					<div class="text-center">
					  <ul class="pagination">
						<li class="page-item">
						  <a class="page-link" href="positions.php?p=1&c=<? echo $c; ?>&s=<? echo $s; ?>&sc=<? echo $sc; ?>&ca=<? echo $ca; ?>&co=<? echo $co; ?>" aria-label="Previous">
						...
						<?
							...
							for ($idz = $start_paggination; $idz <= $end_paggination; $idz++)
							{
								...
								{
						?>
									<li class="page-item active"><a class="page-link" href="positions.php?p=<? echo $idz; ?>&c=<? echo $c; ?>&s=<? echo $s; ?>&sc=<? echo $sc; ?>&ca=<? echo $ca; ?>&co=<? echo $co; ?>"><? echo $idz; ?></a></li>
						<?	
								}
								else
								{
						?>
									<li class="page-item"><a class="page-link" href="positions.php?p=<? echo $idz; ?>&c=<? echo $c; ?>&s=<? echo $s; ?>&sc=<? echo $sc; ?>&ca=<? echo $ca; ?>&co=<? echo $co; ?>"><? echo $idz; ?></a></li>
						<?
								}	
							}
						...
						?>			
						<li class="page-item">
						  <a class="page-link" href="positions.php?p=<? echo $num_of_pages; ?>&c=<? echo $c; ?>&s=<? echo $s; ?>&sc=<? echo $sc; ?>&ca=<? echo $ca; ?>&co=<? echo $co; ?>" aria-label="Next">

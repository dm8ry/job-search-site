...
-- Generation Time: Jun 22, 2016 at 03:12 PM
...
INSERT INTO `category` (`id`, `cat_name`, `cat_name_heb`, `cat_ord`) VALUES
(1, 'Administration', 'אדמיניסטרציה', 1),
(2, 'Internet', 'אינטרנט', 2),
(3, 'Insurance', 'ביטוח', 3),
(4, 'Senior / Management', 'בכירים / ניהול', 4),
(5, 'Professionals', 'בעלי מקצוע', 5),
(6, 'Training / Teaching', 'הדרכה / הוראה', 6),
(7, 'QA hitech', 'הייטק-QA', 7),
(8, 'High-Tech Hardware', 'הייטק-חומרה', 8),
(9, 'High-Tech General', 'הייטק-כללי', 9),
(10, 'High-Tech Software', 'הייטק-תוכנה', 10),
(11, 'Engineering', 'הנדסה', 11),
(12, 'General', 'כללי', 12),
(13, 'Finance', 'כספים', 13),
(14, 'Logistics / Forwarding', 'לוגיסטיקה / שילוח', 14),
(15, 'Science / Biotech', 'מדעים / ביוטק', 15),
(16, 'Sales', 'מכירות', 16),
(17, 'Restaurant / Tourism', 'מסעדנות / תיירות', 17),
(18, 'Human Resources', 'משאבי אנוש', 18),
(19, 'Work from home', 'עבודה מהבית', 19),
(20, 'Design', 'עיצוב', 20),
(21, 'Attorney', 'עריכת דין', 21),
(22, 'Advertising / Media', 'פרסום / מדיה', 22),
(23, 'Vehicle / Transport', 'רכב / תחבורה', 23),
(24, 'Medical / Health', 'רפואה / בריאות', 24),
(25, 'Marketing', 'שיווק', 25),
(26, 'Customer Service', 'שירות לקוחות', 26),
(27, 'Keeping / Security', 'שמירה / אבטחה', 26),
(28, 'Industry / Manufacturing', 'תעשיה / ייצור', 28);
